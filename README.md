...
> 读取项目文件夹中的 SKILL.md，自动提取名称和描述，生成 GitHub README，并推送到 GitHub 仓库。项目文件夹必须已包含 SKILL.md 文件。

[![GitHub](https://img.shields.io/badge/GitHub-skillupload-blue)](https://github.com/LyonLi0214/skillupload)
